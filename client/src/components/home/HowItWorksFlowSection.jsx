  ...
  const steps = [
    {
      ...
      desc: isHindi
        ? 'वेब, मोबाइल, एआई और यूआई/यूएक्स में अपनी पसंद का स्किल ट्रैक चुनें।'
  ...
  return (
    <section className="py-24 px-4 sm:px-8 bg-[var(--canvas)] relative overflow-hidden">
      <div className="max-w-5xl mx-auto text-center">
        {/* Title */}
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold font-manrope text-[var(--ink)] tracking-tight mb-20">
          ...
          {steps.map((step, index) => {
            ...
            return (
              <div key={step.id} className="relative flex flex-col items-center group">
                ...
                {/* Soft Glowing Colored Icon Tile (Exact Reference Screenshot Style) */}
                <motion.div
                  ...
                  className={`relative z-10 w-20 h-20 sm:w-24 sm:h-24 rounded-3xl ${step.bgColor} ${step.shadowColor} flex items-center justify-center text-white mb-8 transition-transform duration-300`}
                >
                  <IconComp className="w-10 h-10 sm:w-11 sm:h-11 stroke-[2]" />
                </motion.div>
                ...
                >
                  <h3 className="text-lg sm:text-xl font-bold font-manrope text-[var(--ink)] mb-2.5">
                    {step.title}
                  </h3>
