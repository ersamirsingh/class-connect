  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <h2 className="text-2xl sm:text-3xl font-extrabold text-[#1E1E2E] dark:text-white">Sign In</h2>
        <p className="text-xs text-slate-500 dark:text-slate-300 mt-1">Access your courses, progress, and live sessions.</p>
      </div>
      ...
      <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
        <span className="text-slate-500 dark:text-slate-300 font-medium">New student to ClassConnect?</span>
        <Link
          to="/signup"
